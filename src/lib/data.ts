...
export const experience = [
  {
    ...
    desc: "Ship production AI and backend systems for a SaaS platform. Built an LLM-powered recruitment automation engine (email-triggered resume ingestion → NLP candidate ranking → automated interview scheduling), a permission-aware RAG Knowledge Base with role-level retrieval across CRM, HRMS and Payroll modules, and a WebSocket video-conferencing module on mediasoup SFU architecture.",
    tags: ["LLMs", "RAG", "NLP", "WebSockets", "Python"],
  },
  {
    role: "Open Source Contributor",
    org: "GirlScript Summer of Code 2024",
    period: "May — Aug 2024",
    desc: "Contributed to open-source Python projects during GSSoC 2024 — resolving real GitHub issues with algorithmic problem-solving and root-cause analysis, working alongside global maintainers to strengthen production codebases.",
  ...
  },
  {
    ...
    org: "SukEm TechLab",
    period: "May — Jun 2024",
    desc: "Wrote Python scripts to automate data-processing tasks and cut manual effort, delivering efficient, maintainable solutions independently in a remote setup.",
